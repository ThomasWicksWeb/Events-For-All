...
<?php require './navbar.php'; ?>
    ...
    <section class="section">
            <div class="container">
                ...
                <a href="#" class="button is-info is-pulled-right is-size-6">Edit Details</a>
                ...
                <ul class="dataSetGrid">
                    ...
                    <li class="dataSet">
                        ...
                        <p class="is-size-6">{{ First Name }}</p>
                    </li>
                    <li class="dataSet">
                        <h5 class="is-size-5 has-text-weight-bold">Last Name:</h5>
                        <p class="is-size-6">{{ Last Name }}</p>
                    </li>
                    <li class="dataSet">
